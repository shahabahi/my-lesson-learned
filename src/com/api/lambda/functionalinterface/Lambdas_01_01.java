 ...
 */
package com.api.lambda.functionalinterface;
...
public class Lambdas_01_01 {
    ...
    public static void main(String[] args) {
        ...
        //BiFunction example
        BiFunction<Integer,Integer,String> biConverter = (num,num1)-> Integer.toString(num * num1);
        System.out.println("26 Multiple 11 is: " + biConverter.apply(26,11));
